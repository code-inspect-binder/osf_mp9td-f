...
# PRE-PROCESSING RAW DATA EXPERIMENT 2 (THIRD-PARTY)
# Preparing raw data for "TablePrep_third.R" Script
...
# import utility functions from util function folder
...
for (subject in participants) {
 ...
 write.table(df_subject, file=paste(interface$tablesDir, subject, sep = ""), sep='\t', row.names = FALSE)
